...
IT ALSO NOW RETURNS NUMBER OF NODES
'''
...
'''
Chat prompt: can you generate me a txt file with a networkX graph?

Response: The edges.txt file I am using for the assignment :)

Chat prompt: will you explain to me this code line by line with comments?
*This was with the in class code to make sure I knew what everything was already doing and checking my work
