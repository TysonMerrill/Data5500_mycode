...
IT ALSO NOW RETUNRS NUMBER OF NODES AND NODES WITH A DEGREE GREATER THAN 5
'''
...
def nodes_with_degree_greater_than_5(graph: nx.Graph) -> int:
...
edges_fil = curr_dir + "/" + "edges1.txt" # dirname and __file__ (this file) returns the current folder
...
# print all nodes
print(g.nodes)
print(f"Number of nodes: {count_nodes(g)}")  # This will print the number of nodes in the graph
...
print(f"Number of nodes: {count_nodes(g)}")  # This will print the number of nodes in the graph
print(f"Number of nodes with degree greater than 5: {nodes_with_degree_greater_than_5(g)}")



'''
Chat prompt: can you make my edges.txt file a lot bigger so certain nodes have a degree greater tahn 5

Response: edges1.txt file I am using
